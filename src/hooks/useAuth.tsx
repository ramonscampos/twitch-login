import { AuthRequest, makeRedirectUri, revokeAsync, startAsync } from 'expo-auth-session';
...
function AuthProvider({ children }: AuthProviderData) {
  ...
  async function signIn() {
    try {
      setIsLoggingIn(true);
      const REDIRECT_URI = makeRedirectUri({ useProxy: true }); // - create OAuth redirect URI using makeRedirectUri() with "useProxy" option set to true
